<img src="https://og.sznm.dev/api/generate?heading=nextarter-chakra-new&text=Next.js+template+with+Chakra-UI+and+TypeScript+setup.&template=color&center=true&height=330" />
